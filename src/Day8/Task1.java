...
* Важно понимать, что это одна строка, полученная
* конкатенацией (“склеиванием”) чисел из диапазона
* через пробел (0 + “ “ + 1 + “ “ + 2 + ... + 20000).
После создания такой строки, вызов System.out.println()
* на этой строке должен вывести в консоль сразу все
* числа из диапазона:
...
*  между конкатенацией обычных строк (класс String) и
*  использовании StringBuilder, реализуйте описанную
...
public class Task1 {
    public static void main(String[] args) {
        ...
        System.out.println("Время выполнения цикла с классом StringBuilder = "+(after1-before1));
