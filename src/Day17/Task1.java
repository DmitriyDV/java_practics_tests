...
*  конь (англ. knight) и пешка (англ. pawn). В нашей программе,
*  у каждой шахматной фигуры есть следующие характеристики:
...
* Пешка (белая) ♙ Конь (белый) ♘ Слон (белый) ♗ Ладья (белая) ♖ Ферзь (белый) ♕ Король (белый) ♔
* Пешка (черная) ♟
*
* Конь (черный) ♞ Слон (черный) ♝ Ладья (черная) ♜ Ферзь (черный) ♛ Король (черный) ♚
* Используя созданный enum, в методе main()класса Task1создайте массив,
* содержащий 4 белых пешки и 4 черных ладьи. Выведите содержимое этого массива на экран,
...
public class Task1 {
    public static void main(String[] args) {
        ...
        for (ChessPiece chessPiece1: pieces)
            System.out.println(chessPiece1.getRepresentation());
